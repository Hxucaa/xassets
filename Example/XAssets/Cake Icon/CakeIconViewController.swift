...
class CakeIconViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        imageView.rac_image <~ AssetFactory.getImage(Asset.CakeIcon(size: imageView.frame.size, backgroundColor: nil, opaque: nil, imageContextScale: nil, pressed: false, shadow: false))
