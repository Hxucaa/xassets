...
class ShareButtonViewController: UIViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        imageView.rac_image <~ AssetFactory.getImage(Asset.ShareButton(size: imageView.frame.size, backgroundColor: nil, opaque: nil, imageContextScale: nil, pressed: false, shadow: false))
