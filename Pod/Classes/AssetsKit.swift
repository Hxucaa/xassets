...
//  XAssets
//
//  Created by Connor Wang on 8/13/15.
...
public class AssetsKit : NSObject {
    ...
    public class func drawCarIcon(#scale: CGFloat) {
        ...
        //// Bezier Drawing
        CGContextSaveGState(context)
        CGContextTranslateCTM(context, 0.85, 1)
        CGContextScaleCTM(context, scale, scale)

        var bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPointMake(23.65, 16.52))
        bezierPath.addCurveToPoint(CGPointMake(21.29, 14.16), controlPoint1: CGPointMake(22.35, 16.52), controlPoint2: CGPointMake(21.29, 15.47))
        bezierPath.addCurveToPoint(CGPointMake(23.65, 11.8), controlPoint1: CGPointMake(21.29, 12.86), controlPoint2: CGPointMake(22.35, 11.8))
        bezierPath.addCurveToPoint(CGPointMake(26.01, 14.16), controlPoint1: CGPointMake(24.95, 11.8), controlPoint2: CGPointMake(26.01, 12.86))
        bezierPath.addCurveToPoint(CGPointMake(23.65, 16.52), controlPoint1: CGPointMake(26.01, 15.47), controlPoint2: CGPointMake(24.95, 16.52))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(3.56, 14.16))
        bezierPath.addCurveToPoint(CGPointMake(5.92, 11.8), controlPoint1: CGPointMake(3.56, 12.86), controlPoint2: CGPointMake(4.61, 11.8))
        bezierPath.addCurveToPoint(CGPointMake(8.28, 14.16), controlPoint1: CGPointMake(7.22, 11.8), controlPoint2: CGPointMake(8.28, 12.86))
        bezierPath.addCurveToPoint(CGPointMake(5.92, 16.52), controlPoint1: CGPointMake(8.28, 15.47), controlPoint2: CGPointMake(7.22, 16.52))
        bezierPath.addCurveToPoint(CGPointMake(3.56, 14.16), controlPoint1: CGPointMake(4.61, 16.52), controlPoint2: CGPointMake(3.56, 15.47))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(7.15, 3.9))
        bezierPath.addCurveToPoint(CGPointMake(22.39, 3.9), controlPoint1: CGPointMake(10.21, 1.89), controlPoint2: CGPointMake(19.33, 1.89))
        bezierPath.addCurveToPoint(CGPointMake(24.45, 7.81), controlPoint1: CGPointMake(22.99, 4.29), controlPoint2: CGPointMake(23.75, 5.87))
        bezierPath.addLineToPoint(CGPointMake(5.08, 7.81))
        bezierPath.addCurveToPoint(CGPointMake(7.15, 3.9), controlPoint1: CGPointMake(5.78, 5.87), controlPoint2: CGPointMake(6.55, 4.29))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(28.18, 10.33))
        bezierPath.addCurveToPoint(CGPointMake(23.71, 1.9), controlPoint1: CGPointMake(27.43, 8.35), controlPoint2: CGPointMake(24.82, 2.63))
        bezierPath.addCurveToPoint(CGPointMake(5.83, 1.9), controlPoint1: CGPointMake(19.87, -0.63), controlPoint2: CGPointMake(9.67, -0.63))
        bezierPath.addCurveToPoint(CGPointMake(1.3, 10.33), controlPoint1: CGPointMake(4.72, 2.63), controlPoint2: CGPointMake(2.05, 8.35))
        bezierPath.moveToPoint(CGPointMake(1.3, 10.33))
        bezierPath.addCurveToPoint(CGPointMake(0, 13.86), controlPoint1: CGPointMake(0.43, 11.33), controlPoint2: CGPointMake(0, 12.6))
        bezierPath.addCurveToPoint(CGPointMake(1.67, 17.83), controlPoint1: CGPointMake(-0.01, 15.42), controlPoint2: CGPointMake(0.59, 16.83))
        bezierPath.addCurveToPoint(CGPointMake(1.71, 17.86), controlPoint1: CGPointMake(1.68, 17.84), controlPoint2: CGPointMake(1.7, 17.85))
        bezierPath.addLineToPoint(CGPointMake(1.71, 20.91))
        bezierPath.addCurveToPoint(CGPointMake(2.91, 22.11), controlPoint1: CGPointMake(1.71, 21.57), controlPoint2: CGPointMake(2.24, 22.11))
        bezierPath.addLineToPoint(CGPointMake(5.71, 22.11))
        bezierPath.addCurveToPoint(CGPointMake(6.91, 20.91), controlPoint1: CGPointMake(6.37, 22.11), controlPoint2: CGPointMake(6.91, 21.57))
        bezierPath.addLineToPoint(CGPointMake(6.91, 19.69))
        bezierPath.addLineToPoint(CGPointMake(22.63, 19.69))
        bezierPath.addLineToPoint(CGPointMake(22.63, 20.91))
        bezierPath.addCurveToPoint(CGPointMake(23.83, 22.11), controlPoint1: CGPointMake(22.63, 21.57), controlPoint2: CGPointMake(23.16, 22.11))
        bezierPath.addLineToPoint(CGPointMake(26.63, 22.11))
        bezierPath.addCurveToPoint(CGPointMake(27.83, 20.91), controlPoint1: CGPointMake(27.29, 22.11), controlPoint2: CGPointMake(27.83, 21.57))
        bezierPath.addLineToPoint(CGPointMake(27.83, 17.92))
        bezierPath.addCurveToPoint(CGPointMake(29.54, 13.97), controlPoint1: CGPointMake(28.98, 16.87), controlPoint2: CGPointMake(29.53, 15.42))
        bezierPath.addCurveToPoint(CGPointMake(28.18, 10.33), controlPoint1: CGPointMake(29.54, 12.66), controlPoint2: CGPointMake(29.1, 11.35))
    ...
    public class func drawEtcIcon(#scale: CGFloat) {
        ...
        var bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPointMake(25, 12.5))
        ...
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(57, 12.5))
        bezierPath.addCurveToPoint(CGPointMake(44.5, 0), controlPoint1: CGPointMake(57, 5.6), controlPoint2: CGPointMake(51.4, 0))
        bezierPath.addCurveToPoint(CGPointMake(32, 12.5), controlPoint1: CGPointMake(37.6, -0), controlPoint2: CGPointMake(32, 5.6))
        bezierPath.addCurveToPoint(CGPointMake(44.5, 25), controlPoint1: CGPointMake(32, 19.4), controlPoint2: CGPointMake(37.6, 25))
        bezierPath.addCurveToPoint(CGPointMake(57, 12.5), controlPoint1: CGPointMake(51.4, 25), controlPoint2: CGPointMake(57, 19.4))
        bezierPath.closePath()
        bezierPath.moveToPoint(CGPointMake(90, 12.5))
        bezierPath.addCurveToPoint(CGPointMake(77.5, 0), controlPoint1: CGPointMake(90, 5.6), controlPoint2: CGPointMake(84.4, 0))
        bezierPath.addCurveToPoint(CGPointMake(65, 12.5), controlPoint1: CGPointMake(70.6, -0), controlPoint2: CGPointMake(65, 5.6))
        bezierPath.addCurveToPoint(CGPointMake(77.5, 25), controlPoint1: CGPointMake(65, 19.4), controlPoint2: CGPointMake(70.6, 25))
        bezierPath.addCurveToPoint(CGPointMake(90, 12.5), controlPoint1: CGPointMake(84.4, 25), controlPoint2: CGPointMake(90, 19.4))
        bezierPath.closePath()
    ...
    public class func drawWTGButtonUntapped(#scale: CGFloat) {
        ...
        bezier3Path.moveToPoint(CGPointMake(67.98, 7.39))
        bezier3Path.addCurveToPoint(CGPointMake(11.49, 36.6), controlPoint1: CGPointMake(55.34, 7.39), controlPoint2: CGPointMake(11.49, 36.6))
        bezier3Path.addCurveToPoint(CGPointMake(6.97, 44.93), controlPoint1: CGPointMake(8.99, 38.23), controlPoint2: CGPointMake(6.97, 41.96))
        bezier3Path.addLineToPoint(CGPointMake(6.97, 99.85))
        bezier3Path.addCurveToPoint(CGPointMake(11.57, 108.05), controlPoint1: CGPointMake(6.97, 102.82), controlPoint2: CGPointMake(9.03, 106.49))
        bezier3Path.addCurveToPoint(CGPointMake(67.98, 136.66), controlPoint1: CGPointMake(11.57, 108.05), controlPoint2: CGPointMake(57.27, 136.66))
        bezier3Path.addCurveToPoint(CGPointMake(124.4, 108.05), controlPoint1: CGPointMake(78.7, 136.66), controlPoint2: CGPointMake(124.4, 108.05))
        bezier3Path.addCurveToPoint(CGPointMake(129, 99.85), controlPoint1: CGPointMake(126.95, 106.49), controlPoint2: CGPointMake(129, 102.82))
        bezier3Path.addLineToPoint(CGPointMake(129, 44.93))
        bezier3Path.addCurveToPoint(CGPointMake(124.48, 36.6), controlPoint1: CGPointMake(129, 41.96), controlPoint2: CGPointMake(126.97, 38.23))
        bezier3Path.addCurveToPoint(CGPointMake(67.98, 7.39), controlPoint1: CGPointMake(124.48, 36.6), controlPoint2: CGPointMake(80.63, 7.39))
        ...
        bezier3Path.addCurveToPoint(CGPointMake(129.91, 112.44), controlPoint1: CGPointMake(135, 106.59), controlPoint2: CGPointMake(132.73, 110.7))
    ...
    public class func drawPriceTagBackground(#scale: CGFloat) {
        ...
        rectanglePath.moveToPoint(CGPointMake(0, 76))
        rectanglePath.addLineToPoint(CGPointMake(183, 76))
        rectanglePath.addLineToPoint(CGPointMake(217, 40))
        rectanglePath.addLineToPoint(CGPointMake(183, 0))
        rectanglePath.addLineToPoint(CGPointMake(0, 0))
        rectanglePath.addLineToPoint(CGPointMake(0, 76))
